...
#
# ssd_synth_run_recreate.tcl: Tcl script for re-creating project 'ssd_synth_run'
#
# Generated by Vivado on Sat Apr 19 23:14:21 -0400 2025
...
#
# 1. This project restoration tcl script (ssd_synth_run_recreate.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Artix7-ASL-Classifier/Synth/SSD_TOP/ssd_synth_run/ssd_synth_run.srcs/utils_1/imports/synth_1/ssd_io_top.dcp"
#
...
#    "C:/Artix7-ASL-Classifier/Synth/SSD_TOP/ssd_io_top.sv"
#    "C:/Artix7-ASL-Classifier/Synth/SSD_TOP/ssd_top_constraints.xdc"
#    "C:/Artix7-ASL-Classifier/Synth/SSD_TOP/ssd_io_top_tb.sv"
#    "C:/Artix7-ASL-Classifier/RTL/HW/sources_1/new/ahb_intf.vh"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ssd_synth_run/ssd_synth_run.srcs/utils_1/imports/synth_1/ssd_io_top.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/ssd_io_top.sv"]"\
 "[file normalize "$origin_dir/ssd_top_constraints.xdc"]"\
 "[file normalize "$origin_dir/ssd_io_top_tb.sv"]"\
 "[file normalize "$origin_dir/../../RTL/HW/sources_1/new/ahb_intf.vh"]"\
...
set _xil_proj_name_ "ssd_synth_run"
...
set script_file "ssd_synth_run_recreate.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/ssd_synth_run"]"
...
set file "$origin_dir/ssd_io_top.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "ssd_io_top" -objects $obj
...
set file "[file normalize "$origin_dir/ssd_top_constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ssd_top_constraints.xdc"
set file [file normalize $file]
...
set file "$origin_dir/ssd_io_top_tb.sv"
set file [file normalize $file]
...
set_property -name "top" -value "ssd_io_top_tb" -objects $obj
...
set file "synth_1/ssd_io_top.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/ssd_io_top.dcp" -objects $obj
